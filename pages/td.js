...
const props = {
    ...
    about: `Технический дизайн очень разнонаправленный по видам деятельности кружок.
        ...
        компьютерной растровой и векторной графики.
        Мы Колористику, правила композиции, векторные редакторы Illustrator и
        Corel Draw, растровый редактор Photoshop.`
}

export default () => (
    <Page id="techd" title={props.title} about={props.about} images={images}/>
)