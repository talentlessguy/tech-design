...
const props = {
    ...
    about: `Кружок "Техническое Конструирование" для тех - кто видит себя
    архитектором, проектировщиком, конструктором, диайнером. Ребёнок,
    пришедший на занятия в кружек погружается в интересный мир
...
export default () => (
    <Page id="techk" title={props.title} about={props.about} images={images}/>
)